...
def bow(X_train, X_test, y_train, y_test):
    ...
    with open('data/X_train_bow_rest', 'wb') as fp:
        pickle.dump(X_train_bow_rest, fp)
    with open('data/X_test_bow_rest', 'wb') as fp:
        pickle.dump(X_test_bow_rest, fp)
    with open('data/y_train_bow_rest', 'wb') as fp:
        pickle.dump(y_train, fp)
    with open('data/y_test_bow_rest', 'wb') as fp:
