...
class Classifier:
    ...
    def load_model(self, i):
        file = open("model/aspect_extration/feature_regression_mlp_doc2vec_{}.p".format(i),'rb')
    ...
    def aspect_mlp(self, numEpochs, batch_size, save_file, lr):
        ...
        for epoch in range(numEpochs):
            ...
            if epoch%10 == 0:
                save_path = save_file+'model_doc2vec_' +str(epoch)+'.pth'
                torch.save(net.state_dict(), save_path)

if __name__=="__main__":
    classifier = Classifier('data/yelp/bow/yelp_doc2vec_reviews.p','data/yelp/bow/yelp_doc2vec_labels.p')
